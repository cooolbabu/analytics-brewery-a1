...
export async function getProviderModels() {
  const modelsList = {
    ...
    personas: [
      ...
      { assistant: "WorldwideImporters", instructions: "Dataarchitect" },
      { assistant: "NorthwindTraders", instructions: "Dataarchitect" },
      { assistant: "AdventureWorks", instructions: "Dataarchitect" },
    ],
  };
  return modelsList;
}
