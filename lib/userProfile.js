    ...
    personas: [
      {
        ...
        instructions:
          ...
          "All Table names and all column names must be enclosed in double quotes. " +
          "Database dialect is PostgreSQL. " +
          "If unable to provide a query, inform the user. " +
          "Your response must be SQL query with comments in a Markdown code block, formatted using best practices and marked as SQL. ",
